    ...
    >
      <div className="bg-brand-black text-white rounded-2xl shadow-2xl p-4 max-w-sm mx-auto sm:mx-0">
        <div className="flex items-start gap-3">
          {/* Icon */}
          <div className="p-2 bg-brand-lime/20 rounded-xl shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2">
              <button
                onClick={updateApp}
                className="flex-1 py-2 px-3 bg-brand-lime text-brand-black font-semibold text-xs rounded-xl hover:bg-brand-lime/90 active:scale-[0.98] transition-all touch-manipulation"
              >
                Mettre à jour
              </button>
              <button
